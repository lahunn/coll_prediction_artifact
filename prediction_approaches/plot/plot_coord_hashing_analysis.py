...
class CoordHashingPlotter:
    ...
    def plot_variable_analysis(
        ...
        fig.suptitle(
            f"Coordinate Hashing Analysis - {variable} Variation ({', '.join(title_parts)})",
            fontsize=16,
            fontweight="bold",
            y=0.995,
        )
    ...
    def plot_multi_curves(
        ...
        title_parts = [f"{k}={v}" for k, v in fixed_params.items()]
        fig.suptitle(
            f"Coordinate Hashing Analysis - {x_variable} vs {group_variable} ({', '.join(title_parts)})",
            fontsize=16,
            fontweight="bold",
            y=0.995,
        )
...
def main():
    ...
    print("\n" + "=" * 60)
    print(
        "Example 1: Threshold Analysis (fixed Density=dens6, QuantBits=4, SampleRate=1.0)"
    )
    print("=" * 60)
    plotter.plot_variable_analysis(
        variable="Threshold",
    ...
    print("\n" + "=" * 60)
    print(
        "Example 2: QuantBits Analysis (fixed Density=dens6, Threshold=0.125, SampleRate=1.0)"
    )
    print("=" * 60)
    plotter.plot_variable_analysis(
        variable="QuantBits",
    ...
    print("\n" + "=" * 60)
    print(
        "Example 3: Multi-Density Comparison (Threshold vs Density, fixed QuantBits=4, SampleRate=1.0)"
    )
    print("=" * 60)
    plotter.plot_multi_curves(
        x_variable="Threshold",
    ...
    print("\n" + "=" * 60)
    print(
        "Example 4: QuantBits Comparison (Threshold vs QuantBits, fixed Density=dens6, SampleRate=1.0)"
    )
    print("=" * 60)
    plotter.plot_multi_curves(
        x_variable="Threshold",
